      ...
      },
      {
        ...
        body: (
          <p>
            ...
            to a roof, so the drawing turns with it. They replace whatever is on screen; Undo, or
            Ctrl+Z (Cmd+Z on a Mac), brings your own build-up back. None is taken from anyone else's
            example library.
          </p>
        ),
      },
